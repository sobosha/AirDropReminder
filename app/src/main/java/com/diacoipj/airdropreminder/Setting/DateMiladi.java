...
public class DateMiladi
{
	...
	public static String getDay (int day) {
		switch (day) {
			case 1 : return MainActivity.getGlobal().getResources().getString(R.string.Sunday).substring   (0,Setting.isEnLang()? 2 : 1);
			case 2 : return MainActivity.getGlobal().getResources().getString(R.string.Monday).substring   (0,Setting.isEnLang()? 2 : 1);
			case 3 : return MainActivity.getGlobal().getResources().getString(R.string.Tuesday).substring  (0,Setting.isEnLang()? 2 : 1);
			case 4 : return MainActivity.getGlobal().getResources().getString(R.string.Wednesday).substring(0,Setting.isEnLang()? 2 : 1);
			case 5 : return MainActivity.getGlobal().getResources().getString(R.string.Thursday).substring (0,Setting.isEnLang()? 2 : 1);
			case 6 : return MainActivity.getGlobal().getResources().getString(R.string.Friday).substring   (0,Setting.isEnLang()? 2 : 1);
			case 7 : return MainActivity.getGlobal().getResources().getString(R.string.Saturday).substring (0,Setting.isEnLang()? 2 : 1);
			default:return "";
		}
	}
	...
	public long mPrintDifferenceFormatMilliAbs(Date startDate, Date endDate) {
		long myDate = endDate.getTime() - startDate.getTime();
		return myDate;
	}
}