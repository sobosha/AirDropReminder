...
package com.diacoipj.airdropreminder.Setting.CustomTimerPicker.time;
...
public class RadialTextsView extends View {
    ...
    public void initialize(Context context, String[] texts, String[] innerTexts,
        ...
        mTypefaceLight = Typeface.createFromAsset(MainActivity.getGlobal().getBaseContext().getAssets() , "fonts/dana_fa_num_regular.ttf");
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (!mDrawValuesReady) {
            ...
            mTextSize = mCircleRadius * mTextSizeMultiplier*2f;
            if (mHasInnerCircle) {
                mInnerTextSize = mCircleRadius * mInnerTextSizeMultiplier*2.2f;
            }
...
//        mPaint.setTypeface(typeface);
        Typeface tf = Typeface.createFromAsset(MainActivity.getGlobal().getBaseContext().getAssets(),"fonts/dana_fa_num_regular.ttf");
