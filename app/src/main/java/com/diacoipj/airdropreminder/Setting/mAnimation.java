...
public class mAnimation {
    ...
    public static Animation myScaleCusom(final View NewView, float fromX, float fromY, float toX, float toY, long startOffset, int duration) {
    ...
    public static void scaleWIthAnimate (View view , float scaleX , float scaleY , int duration) {
        view.animate()
                .scaleY(scaleX)
                .scaleX(scaleY)
    ...
    public static void ViberationYWithRepeat(View rel) {
        Animation anim = new TranslateAnimation(0, 0, 0, -15);
