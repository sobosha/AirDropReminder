...
public class mUniversalVideoView extends SurfaceView
        implements mUniversalMediaController.MediaPlayerControl, OrientationDetector.OrientationChangeListener{
    private String TAG = "mUniversalVideoView";
    ...
    private mUniversalMediaController mMediaController;
    ...
    private mUniversalVideoView.VideoViewCallback videoViewCallback;

    public mUniversalVideoView(Context context) {
        this(context,null);
    }

    public mUniversalVideoView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public mUniversalVideoView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(mUniversalVideoView.class.getName());
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
            info.setClassName(mUniversalVideoView.class.getName());
        }
    }
    ...
    public void setMediaController(mUniversalMediaController controller) {
...
//                    }
    ...
    private void enableOrientationDetect() {
        if (mAutoRotation && mOrientationDetector == null) {
            ...
            mOrientationDetector.setOrientationChangeListener(mUniversalVideoView.this);
...
*/
    ...
    public void setVideoViewCallback(mUniversalVideoView.VideoViewCallback callback) {
