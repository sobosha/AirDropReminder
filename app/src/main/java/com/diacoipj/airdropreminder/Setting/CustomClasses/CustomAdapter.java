...
import com.diacoipj.airdropreminder.Setting.RtlGridLayoutManager;
...
public class CustomAdapter<T, P> extends RecyclerView.Adapter<CustomAdapter.ViewHolder> {
    ...
    public static final class RecyclerBuilder<Model, View> {
        ...
        boolean staggered ;
        public RecyclerBuilder<Model, View> staggered (int spanCount) {
            staggered = true ;
            this.spanCount = spanCount;
            return this;
        }
        ...
        public CustomAdapter<Model, View> build() {
            if (!staggered) {
                ...
                recyclerView.setLayoutManager(new StaggeredGridLayoutManager(spanCount , orientation == -1 ? StaggeredGridLayoutManager.VERTICAL : orientation));
