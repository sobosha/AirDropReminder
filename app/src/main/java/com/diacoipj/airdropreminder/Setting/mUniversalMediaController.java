...
public class mUniversalMediaController extends FrameLayout {


    private mUniversalMediaController.MediaPlayerControl mPlayer;
...
//    private boolean mFullscreenEnabled = false;
    ...
    public mUniversalMediaController(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    ...
    public mUniversalMediaController(Context context) {
        super(context);
        init(context);
    }
    ...
    public void setMediaPlayer(mUniversalMediaController.MediaPlayerControl player) {
        mPlayer = player;
        updatePausePlay();
    }
...
//            mCenterPlayButton.setVisibility(VISIBLE);
    ...
    public void setOnCompleteVideo (updateMyData updateMyData) {
